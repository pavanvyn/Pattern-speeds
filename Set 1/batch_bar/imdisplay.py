...
for index in range(num_files):
	...
	plt.plot(x_slit,y_slit,color="black",linestyle="solid",linewidth=1)
	plt.plot(x_slit,y_slit+5,color="black",linestyle="solid",linewidth=1)
	plt.plot(x_slit,y_slit-5,color="black",linestyle="solid",linewidth=1)
	plt.plot(x_slit,y_slit+10,color="black",linestyle="solid",linewidth=1)
	plt.plot(x_slit,y_slit-10,color="black",linestyle="solid",linewidth=1)
